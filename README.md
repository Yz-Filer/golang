...
> [!NOTE]  
> 「https://yz-filer.github.io/golang/」で表示されてて表示が崩れてる場合は、上記リンクからオリジナルページにアクセスして下さい。  
...
まとめ3も終わったので、また、思いついたテーマを追加していきます。  
go言語の知識と根気さえあれば、Windows環境でファイラーが作成できる程度の情報は確認出来てきたのではないかと思います。  
